    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Acheivers Playlist</h5>
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Add Acheivers Playlist</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/admin">DashBoard</a></li>
                    <li class="breadcrumb-item active">Add Acheivers Playlist</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="col-12">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Acheivers Playlist ()</h3>
            </div>
                ...
                <table class="table table-hover text-nowrap table-bordered table-extra" id="rtable"
                    ...
                    @endphp
                            <tr>
                                ...
                                <td align="center">
                                    <a class="btn btn-info btn-sm text-light" onclick="PlaylistEdit('{{ $Playlist->id }}','{{ $Playlist->playlist }}')">Edit</a>
                                    <a class="btn btn-danger btn-sm text-light" onclick="Playlistdelete('{{ $Playlist->id }}')">Delete</a>
                                </td>
                            </tr>
                        @endforeach
