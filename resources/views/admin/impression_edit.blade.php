            ...
            <form>
                            ...
                            <div class="form-group ">
                                ...
                                <select class="form-control select2bs4" id="playlist" style="width: 100%;">
                                    ...
                                    @foreach ($Playlists as $Playlist)
                                        <option value="{{ $Playlist->id }}" @if($Playlist->id==$Impression->playlist) selected @endif>{{ $Playlist->playlist }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Enter Embed Video Url" name="video_url"
                                    type="text" value="{{ $Impression->embeded_url }}" id="video_url">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Enter Video Title " name=""
                                    type="text" value="{{ $Impression->title }}" id="video_title">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Enter Youtube Video Url" name="video_url"
                                    type="url" value="{{ $Impression->youtube_link }}" id="youtube_video_url">
                ...
                <div class="card-footer">
                    ...
                    <button type="button" id="addBtn" class="btn btn-primary float-right"
                        onclick="ImpressionUpdate()"> Update </button>
                </div>
            </form>
        </div>
    </div>
    ...
    function ImpressionUpdate() {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data['success']) {
                    Swal.fire({
                        title: 'Impression Updated Success',
