                ...
                <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Enter User Name" name="title" type="text"
                                    value="{{ $Testimonial->user_name }}" id="user_name">
                                <input type="hidden" name="" id="test_id" value="{{ $Testimonial->id }}">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Enter User University" name="url"
                                    type="text" value="{{ $Testimonial->user_university }}" id="user_university">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="content" class="form-label text-right">User Content<span
                                        class="text-danger">*</span> :</label>
                                <textarea class="form-control" name="content" type="text" id="user_content" rows="4">{{ $Testimonial->user_content }}</textarea>
                    ...
                    <div class="card-footer">
                        ...
                        <button type="button" id="addBtn" class="btn btn-primary float-right"
                            onclick="TestimonialUpdate()"> Update </button>
                    </div>
            </form>
        </div>
    </div>
    ...
    function TestimonialUpdate() {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data['success']) {
                    Swal.fire({
                        title: 'Testimonial Updated Success',
